 ...
 13   call FromCellToGrid(Nx,Ny,Nc,cells,grid)
      ...
      call rs(t,Nx,Ny, Nc,gamma0,ro0,gammak1,rok1,grid,vdx,cells)
!     Runge-Kutta-Merson Method
 ...
 16   do j=1,Ny
      ...
      call rs(t+h/3,Nx,Ny, Nc,gamma,ro,gammak2,rok2,grid,vdx,cells)
      ...
      call rs(t+h/3,Nx,Ny, Nc,gamma,ro,gammak3,rok3,grid,vdx,cells)
      ...
      call rs(t+h/2,Nx,Ny, Nc,gamma,ro,gammak4,rok4,grid,vdx,cells)
     ...
     .   +4*rok4(i,j))/2
      ...
      call rs(t+h,Nx,Ny, Nc,gamma,ro,gammak5,rok5,grid,vdx,cells)
